...
content = content.replace(
  "const [bookingStep, setBookingStep] = useState<'search' | 'details' | 'success'>('search');",
...
// 3. handleDateClick
content = content.replace(
  "setBookingStep('search'); // Reset flow if dates change",
...
// 4. Layout
const widgetStart = content.indexOf('<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10">');
...
const wrapper = `
            <div className="max-w-lg mx-auto relative min-h-[500px]">
...
content = content.substring(0, widgetStart) + wrapper + content.substring(widgetEnd);

fs.writeFileSync(file, content);
console.log("Updated ReservationsClient.tsx successfully");
