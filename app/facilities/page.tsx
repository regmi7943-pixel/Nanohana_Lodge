  ...
  return (
    <div id="facilities-page" className="w-full">
      ...
      <section id="facilities-hero" className="relative h-[55vh] min-h-[380px] w-full flex items-center justify-center">
        <Image
          src="https://picsum.photos/seed/nanohanagarden/1600/900"
        ...
        <div className="relative z-10 text-center px-5 text-cream max-w-[800px] pt-16">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl font-medium tracking-tight mb-4">
            Everything that makes a stay comfortable.
          </h1>
          <p className="text-cream/90 text-sm sm:text-base max-w-[550px] mx-auto leading-relaxed">
            Free high-speed WiFi, piping hot showers, flower-lined balconies, on-site bicycle rentals, and a dedicated family team standing by to handle the rest.
          </p>
        </div>
      </section>
            ...
            return (
              ...
              >
                ...
                <div className="space-y-4 flex-grow">
                  ...
                  <p className="text-sm text-earth/80 leading-relaxed max-w-[700px]">
                    {row.desc}
                  </p>
      ...
      <section id="facilities-sustainability" className="bg-forest text-cream py-20">
        <div className="max-w-[1240px] mx-auto px-5 md:px-10 lg:px-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6">
            ...
            <h2 className="font-serif text-3.5xl md:text-4xl text-cream font-medium leading-tight">
              We take sustainability extremely personally.
            </h2>
            <p className="text-cream/80 text-sm leading-relaxed">
              Nanohana Lodge’s founder Kul Bahadur believes true ecology is rooted in practical common sense. Since our construction, we do not deploy disposable plastic cups or excessive lighting systems. Instead, we rely on natural insulation, recycling flow structures, and deep green community integration.
            </p>
            <p className="text-sage font-serif italic text-base">
              {"\"We aim to prove that budget-friendly Nepalese travels can cooperate fully with the local ecosystem.\""}
            </p>
          </div>

          <div className="lg:col-span-6 grid grid-cols-2 gap-4">
            <div className="p-6 bg-white/5 border border-white/10 rounded-xl text-center space-y-2">
              <span className="block text-3xl font-serif text-nanohana font-bold">2 L Saved</span>
              <span className="text-xs font-mono uppercase tracking-widest text-cream/70 block">Per Flush Cycle</span>
              <p className="text-[11px] text-cream/80 leading-normal">
                Via custom water-bottle cistern restrictors deployed in all 17 bathrooms.
              </p>
            </div>

            <div className="p-6 bg-white/5 border border-white/10 rounded-xl text-center space-y-2">
              <span className="block text-3xl font-serif text-nanohana font-bold">34+ Years</span>
              <span className="text-xs font-mono uppercase tracking-widest text-cream/70 block">Family Hospitality</span>
              <p className="text-[11px] text-cream/80 leading-normal">
                Refined across two generations of central Lakeside innkeeping.
              </p>
            </div>

            <div className="p-6 bg-white/5 border border-white/10 rounded-xl text-center space-y-2">
              <span className="block text-3xl font-serif text-nanohana font-bold">17 Rooms</span>
              <span className="text-xs font-mono uppercase tracking-widest text-cream/70 block">Low Footprint</span>
              <p className="text-[11px] text-cream/80 leading-normal">
                Kept small on purpose to preserve the peaceful neighborhood soundscape.
              </p>
            </div>

            <div className="p-6 bg-white/5 border border-white/10 rounded-xl text-center space-y-2">
              <span className="block text-3xl font-serif text-nanohana font-bold">0 Promises</span>
              <span className="text-xs font-mono uppercase tracking-widest text-cream/70 block">We Cannot Keep</span>
              <p className="text-[11px] text-cream/80 leading-normal">
                No corporate greenwashing. Just practical, direct ways of giving back.
              </p>
            </div>
          </div>
        </div>
